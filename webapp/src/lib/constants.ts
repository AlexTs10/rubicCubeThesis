...
export const ALGORITHMS: Record<Algorithm, AlgorithmInfo> = {
  thistlethwaite: {
    ...
    year: 1981,
    speed: 'Lowest avg time',
    moves: 'Longer',
    description: 'Pure 4-phase group theory solver. Lowest average time in the canonical benchmark, but clearly longer solutions.',
    color: 'yellow',
    emoji: '⚡',
  },
  kociemba: {
    ...
    speed: 'Balanced',
    moves: 'Near-optimal',
    description: '2-phase IDA* search. Best overall practical trade-off in the thesis benchmark.',
    color: 'blue',
    emoji: '🚀',
  },
  korf: {
    ...
    year: 1997,
    speed: 'Depth-sensitive',
    moves: 'Shortest on completed runs',
    description: 'Preview aligned to the external exact-backend benchmark path. Completed benchmark runs are shortest, but hard depth-20 cases can time out.',
    color: 'purple',
    emoji: '🐢',
  },
};
