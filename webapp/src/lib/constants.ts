...
export const ALGORITHMS: Record<Algorithm, AlgorithmInfo> = {
  thistlethwaite: {
    ...
    speed: 'Fast',
    moves: 'Longer',
    description: 'Pure 4-phase group theory solver. Reliable and low-memory, but produces longer solutions.',
    color: 'yellow',
    emoji: '⚡',
  },
  kociemba: {
  ...
  korf: {
    ...
    year: 1997,
    speed: 'Variable',
    moves: 'Optimal when solved',
    description: 'Synthetic demo preview of the external exact backend used in the thesis benchmark. Shortest solutions, but hard cases can time out.',
    color: 'purple',
    emoji: '🐢',
  },
};
