...
\begin{itemize}
    \item \textbf{Εγγύηση}: Στην παρούσα υλοποίηση η ολοκλήρωση όλων των φάσεων δίνει λύση μήκους $\leq 45$ κινήσεις, αθροίζοντας τα διαμορφωμένα phase depths $[7, 10, 13, 15]$ (τυπικά 30--40 στο benchmark). Το ιστορικό άνω φράγμα 52 κινήσεων του Thistlethwaite (1981) ισχύει για τη γενική θεωρητική διατύπωση και όχι για τα συγκεκριμένα όρια αυτής της υλοποίησης.
